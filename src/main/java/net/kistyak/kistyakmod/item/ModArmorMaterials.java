...
public enum ModArmorMaterials implements ArmorMaterial {
    PINKDIAMOND("pinkdiamond", 30, new int[]{2, 5, 8, 3}, 15, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F,
            () -> Ingredient.of(ModItem.PINKDIAMOND.get()));
    ...
    public String getName() {
        return KistyakMod.MOD_ID + ":" + this.name;
    }
